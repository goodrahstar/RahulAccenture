package com.accenture.facequality;
...
public class FaceQualityCheck extends JFrame implements ActionListener {
	...
	public String [] result;
	  ...
	  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	                                     ...
	                                     final String faceDisplayName )
	    {
	        ...
	        if(faceCenter.getX() >= (pch.width()/2)+(pch.width()/4) && faceCenter.getX() < pch.width() )
	        {
	        	System.out.println("Too Right");	
	        	
	        }
	        else if(faceCenter.getX() <= (pch.width()/2)+(pch.width()/4) && faceCenter.getX() > 0 )
	        {
	        ...
	        else
	        {
	        	...
	        	//JOptionPane.showMessageDialog(null, "Face is too Left.");
	        }
	...
	catch (Exception e) 
	{
		...
		photobox.setBounds(10,100,400,600);
